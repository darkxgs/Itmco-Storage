...
تسجيل الدخول يتم عبر Supabase Auth بنفس إيميلات وكلمات مرور الموظفين. إنشاء المستخدمين وتغيير كلمات المرور من صفحة "إدارة المستخدمين" (للمدير فقط).

كلمات المرور لا تُكتب في المستودع (المستودع عام). قائمة الحسابات محفوظة محلياً في `accounts.local.md` ولا يتم رفعها.
